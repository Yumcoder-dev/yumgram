...
it('long - bit operations', () => {
  for (let i = 0; i < TEST_BITS.length; i += 2) {
    ...
    for (let len = 1; len < 64; len += 1) {
      if (len < 32) {
        expect((TEST_BITS[i] << len) | (TEST_BITS[i + 1] >>> (32 - len))).toEqual(
        ...
        expect((TEST_BITS[i + 1] >>> len) | (TEST_BITS[i] << (32 - len))).toEqual(
...
it('long - base default to string', () => {
  ...
  expect('100000000000000000000000000000000000000000000000000000000000001').toEqual(
