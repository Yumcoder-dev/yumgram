...
const Config = {
  Schema: {
    ...
    API: {
      ...
      constructors: [
        ...
        { id: '-17968211', predicate: 'contactLinkNone', params: [], type: 'ContactLink' },
        { id: '646922073', predicate: 'contactLinkHasPhone', params: [], type: 'ContactLink' },
        { id: '-721239344', predicate: 'contactLinkContact', params: [], type: 'ContactLink' },
        {
          id: '2139689491',
        ...
        { id: '281165899', predicate: 'updateLangPackTooLong', params: [], type: 'Update' },
        {
          id: '1442983757',
      ...
      methods: [
        ...
        { id: '-1372724842', method: 'help.getAppUpdate', params: [], type: 'help.AppUpdate' },
        {
          id: '1862465352',
  ...
  Modes: {
    ...
    debug: true, // window.location.search.indexOf('debug=1') > 0,
    http: window.location.search.indexOf('http=1') > 0,
    ssl:
      window.location.search.indexOf('ssl=1') > 0 ||
      (window.location.protocol === 'https:' && window.location.search.indexOf('ssl=0') === -1),
    ...
    ios_standalone:
      window.navigator.standalone && window.navigator.userAgent.match(/iOS|iPhone|iPad/),
    chrome_packed:
      (window.chrome && window.chrome.app && window.chrome.app.window && true) || false,
    animations: true,
    memory_only: false,
